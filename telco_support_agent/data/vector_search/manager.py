...
class VectorSearchManager:
    ...
    def _setup_names(self) -> None:
        ...
        # index names
        self.kb_index_name = self.uc_config.get_uc_index_name(self.config['indexes']['knowledge_base']['name'])
        self.tickets_index_name = self.uc_config.get_uc_index_name(self.config['indexes']['support_tickets']['name'])
