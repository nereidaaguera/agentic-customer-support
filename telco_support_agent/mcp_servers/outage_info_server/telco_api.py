"""
Mocked telco API client module. Exposes a generic `call_telco_service` function that simulates HTTP requests to a backend.
...
async def call_telco_service(method: str, path: str, params: dict = None, body: dict = None) -> str:
    """
